...
-- Convert legacy product-level favorites to the first active catalog color.
...
-- A product without an active color cannot satisfy color-level favorite semantics.
